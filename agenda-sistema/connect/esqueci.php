...
<?php include 'include/php/function_er.php'; ?>
<?php 
	
	$email = $_POST["email"];
	
	$sqli = $conn->prepare("SELECT * FROM cliente WHERE email='$email'");
	$sqli->execute();
	...
	$to = $e;
		...
		<div style="font-family: Arial, Helvetica, sans-serif; font-size: 20px;">
		  ...
		  <div class="tudo fontEmail">
			<strong>Ola '.$nome.' </strong> <br/><br/>Segue abaixo o link para recuperar de sua senha<br/> <a href="'.$dominio.'nova_senha.php?e='.$e.'">Clique aqui para redefinr sua Senha</a><br/><br/>
