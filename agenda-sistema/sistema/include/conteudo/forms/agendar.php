...
<?php if($dd == $d && $mm == $m && $aa == $a){ ?>
 ...
 <div class="panel panel-success">
      <div class="panel-heading"><h2>Agendamento</h2></div>
      <div class="panel-body">


  <form name="agendar" class="form-horizontal" action="include/insert/agenda.php" method="post">
  
   <?php include './include/buscas/agendar.php';?>
    ...
    <div class="form-group">
     ...
     <div class="col-xs-8">
	  ...
	  <?php }else{ ?>
	  <input type="hidden" name="ponto" value="0">
	  <?php } ?>
	  ...
	  <?php }else{} ?>
	  <input type="hidden" name="darp" value="<?php echo $_POST["prazo"];?>">
    <div class="form-group">        
