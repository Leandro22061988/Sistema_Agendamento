...
<?php if($dd == $d && $mm == $m && $aa == $a){ ?>
 ...
 <div class="panel panel-success">
  ...
  <form class="form-horizontal" action="agendar_busc_data_edit.php" method="post">
    ...
    <div class="form-group">
      ...
      <label class="control-label col-sm-2" for="profissional">Profissional:</label>
		...
		$mostra = mysqli_fetch_assoc($exag);
			echo "<option>".$mostra["profissional"]."</option>";
		...
		<input type="hidden" name="cliente" value="<?php echo $mostra["id_cliente"]; ?>">
	  </div>
