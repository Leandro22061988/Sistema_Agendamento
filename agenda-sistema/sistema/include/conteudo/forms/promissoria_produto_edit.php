...
<div class="panel-heading"><h2>Promissória Produto - Edição</h2></div>
<div class="panel-body">
  <form name="cliente_cad" class="form-horizontal" action="include/edit/promissoria_produto_edit.php" method="post">
