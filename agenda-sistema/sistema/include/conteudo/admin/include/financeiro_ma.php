<div class="col-sm-6">
      ...
      <div class="panel panel-default">
		  ...
		  <?php 
			$m = $_POST["mm"];
			$a = $_POST["aa"];
			$cons = "SELECT SUM(valor_compra) as SOMA, mes, ano FROM estoque WHERE mes='$m' and ano='$a'";
			$gas = $sql->query($cons);
		  ...
		  <?php 
			...
			$m = $_POST["mm"];
			$a = $_POST["aa"];
			$est = "SELECT SUM(valor) as SOMA, parcelas, dia, mes, ano FROM adesao_curso WHERE mes='$m' and ano='$a' and parcelas = 1";
			$exest = $sql->query($est);
			$pacaixa = 0;
		  ...
		  <?php 
			...
			$m = $_POST["mm"];
			$a = $_POST["aa"];
			$prod = "SELECT SUM(valor) as SOMA, parcelas, dia, mes, ano FROM produto_venda WHERE mes='$m' and ano='$a' and parcelas <= 1";
			$expro = $sql->query($prod);
			$exibpro = mysqli_fetch_assoc($expro);
			  	$calc = $exibpro["SOMA"] + $soma_p;
